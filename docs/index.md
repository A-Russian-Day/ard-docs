...
hero:
  name: "A Russian Day"
  tagline: "Официальная википедия по модификации A Russian Day"
  actions:
    - theme: brand
      text: Сюжет мода
      link: /story/first-chapter.md
    - theme: alt
      text: История версий
      link: /versions/introduction.md
  image:
    light: /ard_logo_black.png
    dark: /ard_logo_white.png
    alt: Логотип A Russian Day
